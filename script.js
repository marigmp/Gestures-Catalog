    ...
    for(var j = 0; j < indexsLeft.length/6; ++j) 
    {
        ...
        for(var i = 0; i < 6; ++i)
        {
            ...
            if(j*6 + i < indexsLeft.length) {
                var title = rows[indexsLeft[j*6 + i]]['title'];
                var indexH = j*6 + i + 1;
                scenesHTML +=  "<td>"+ indexH +"<video id=\"" + title + " class=\"videojs vjs-default-skin\" controls poster=\"http://www.cin.ufpe.br/~gesturescatalog/assets/posters_/"+ title + ".jpg\" preload=\"none\" width=\"360\" height=\"200\" data-setup='{\"controls\":true}'> <source src=\"http://www.cin.ufpe.br/~gesturescatalog/assets/parts/"+ title + ".mp4\" type='video/mp4'/></video></td>";
                //scenesHTML +=  "<td><video id=\"" + title + " class=\"videojs vjs-default-skin\" controls preload=\"auto\" width=\"360\" height=\"200\" data-setup='{\"controls\":true}'> <source src=\"http://www.cin.ufpe.br/~gesturescatalog/assets/parts/"+ title + ".mp4\" type='video/mp4'/></video></td>";

                /*if((rows[indexsLeft[j*6 + i]]['title']).indexOf(title) != -1) {
                    scenesHTML +=  "<td><video id=\"" + title + " class=\"videojs vjs-default-skin\" controls preload=\"auto\" width=\"360\" height=\"200\" data-setup='{\"controls\":true}'> <source src=\"http://www.cin.ufpe.br/~gesturescatalog/assets/parts/"+ title + ".mp4\" type='video/mp4'/></video></td>";
                }*/
    ...
    */
    ...
    for(var j = 0; j < rows.length/6; ++j) 
    {
        ...
        /*<video id="example_video_1" class="video-js vjs-default-skin"
               controls preload="auto" width="360" height="200"
               poster="Enders.Game.2013.1080p.BluRay.x264.anoXmous_part1.mp4.jpg"
               data-setup='{"controls":true}'>
            <source src="Enders.Game.2013.1080p.BluRay.x264.anoXmous_part1.mp4" type='video/mp4'/>
        </video>*/
        ...
        for(var i = 0; i < 6; ++i)
        {
            ...
            if(j*6 + i < rows.length) {
                var title = rows[j*6 + i]['title'];
                //scenesHTML +=  "<td><video id=\"" + title + " class=\"videojs vjs-default-skin\" controls preload=\"auto\" width=\"360\" height=\"200\" data-setup='{\"controls\":true}'> <source src=\"http://www.cin.ufpe.br/~gesturescatalog/assets/parts/"+ title + ".mp4\" type='video/mp4'/></video></td>";
                var indexH = j*6 + i + 1;

                scenesHTML +=  "<td><b>"+ indexH +"</b><video id=\"" + title + " class=\"videojs vjs-default-skin\" controls poster=\"http://www.cin.ufpe.br/~gesturescatalog/assets/posters_/"+ title + ".jpg\" preload=\"none\" width=\"360\" height=\"200\" data-setup='{\"controls\":true}'> <source src=\"http://www.cin.ufpe.br/~gesturescatalog/assets/parts/"+ title + ".mp4\" type='video/mp4'/></video></td>";
